...
| デバイス | 解像度 | オプション |
|----------|--------|------------|
| Kindle Paperwhite | 1236 x 1648 | `-d paperwhite`（デフォルト）|
| Kindle Oasis | 1264 x 1680 | `-d oasis` |
| Kindle Basic | 1072 x 1448 | `-d basic` |
| Kindle Scribe | 1860 x 2480 | `-d scribe` |
